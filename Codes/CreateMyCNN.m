...
numF = 12;    %12
layers = [
    imageInputLayer([numHops,numBands,2],'SplitComplexInputs', 1)  %input channel 2, (no...'SplitComplexInputs', 1)
...
miniBatchSize = 128;
validationFrequency = ceil(numel(YTrain)/miniBatchSize);   %floor->ceil
